...
import 'package:wigo/screens/Coachs/coach_detail_screen.dart';
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                           showNormalSnackBar(context,
                               "Filters coming soon", Colors.black, Colors.white);
                           },
                          icon: const Icon(
                            Icons.filter_list,
                            color: Colors.black,
                ...
                ListView.separated(
                  ...
                  itemBuilder: (c, i) {
                    return GestureDetector(
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => CoachDetailScreen(),)),
                      child: SizedBox(
                        height: 125.h,
