...
import 'package:wigo/screens/Auth/gender_selector_screen.dart';
...
Navigator.of(context).push(MaterialPageRoute(builder: (context) =>GenderSelectorScreen() ));
