...
class AppColors {
  ...
  static const Color primaryColor1 = const Color(0xff92A3FD);
  static const Color  primaryColor2 = const Color(0xff9DCEFF);
  static const Color  secondaryColor1 = const Color(0xffC58BF2);
  static const Color  secondaryColor2 = const Color(0xffEEA4CE);
