...
class Constants {
  ...
  static const String BASE_URL = 'http://192.168.1.6:5000';
  ...
  static const actionModelKey="actionModelKey";

  static const badgeModelKey="badgeModelKey";

  static const banModelKey="banModelKey";

  static const boostModelKey="boostModelKey";

  static const boxModelKey="boxModelKey";

  static const challengeModelKey="challengeModelKey";

  static const charityCategoryModelKey="charityCategoryModelKey";

  static const charityModelKey="charityModelKey";

  static const couponModelKey="couponModelKey";

  static const membershipTypeModelKey="membershipTypeModelKey";

  static const modifiedAttributeModelKey="modifiedAttributeModelKey";

  static const newsModelKey="newsModelKey";

  static const placeModelKey="placeModelKey";

  static const productCategoryModelKey="productCategoryModelKey";

  static const productModelKey="productModelKey";

  static const rarityModelKey="rarityModelKey";

  static const reviewModelKey="reviewModelKey";

  static const workoutModelKey="workoutModelKey";

  static const workoutPartModelKey="workoutPartModelKey";
